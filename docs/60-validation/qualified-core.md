...
- [`jaxstro.units`](../50-api/physical-representations/units.md) is the static-module
  ...
  policy, and [scale/conversion/default evidence](https://github.com/jaxstro/jaxstro/blob/main/tests/unit/test_units.py).
...
- [`jaxstro.numerics.safeguarded_bracketed_root`](../50-api/change-constraints/rootfinding.md)
  ...
  [`tests/validation/test_bracketed_root_algorithms.py`](https://github.com/jaxstro/jaxstro/blob/main/tests/validation/test_bracketed_root_algorithms.py).
- [`jaxstro.numerics.implicit_bracketed_root`](../50-api/change-constraints/rootfinding.md)
  has derivative validation in
  [`tests/validation/test_implicit_root_gradients.py`](https://github.com/jaxstro/jaxstro/blob/main/tests/validation/test_implicit_root_gradients.py).
- [`jaxstro.numerics.universal_kepler_step`](../50-api/change-constraints/kepler.md)
  has fixed-route derivative validation in
  [`tests/validation/test_kepler_gradients.py`](https://github.com/jaxstro/jaxstro/blob/main/tests/validation/test_kepler_gradients.py).
