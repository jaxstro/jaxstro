...
| `provenance.cards` | source_provenance | [artifact source](https://github.com/drannarosen/jaxstro/blob/main/docs/40-api/provenance/index.md) | `sha256:774565a1ed27d5dc0bdc4c583a0c6e75c338553dfd971aa5b1d434301446dffd` | Uses repository-owned source cards; no runtime dataset required. |
