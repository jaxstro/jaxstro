...
| C3 | `docs/index.md` | Landing routes users to implemented quantity, spatial, provenance, and atmosphere boundaries | Import-surface test plus rendered card/link DOM checks |
