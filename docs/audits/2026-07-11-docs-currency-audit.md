...
| C11e+ | `linear-algebra.md`, `spectra-data-architecture.md` | Each remaining illustrative block is either completed or explicitly marked | One page and one focused proof at a time |
