...
| Contract coverage | B+ | [](../../60-validation/qualified-core.md) and [](../../50-api/research-infrastructure/contracts.md) | A deliberately bounded qualified core and public modules have export-audited contracts | 235 public callables remain explicitly unclassified | Prioritized callable coverage with tested transform and failure claims |
