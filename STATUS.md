...
next: Execute the approved `jaxstro.quad` Phase A0 foundation plan inline with read-only subagent reviews at checkpoints A0-C1 and A0-C2. Do not begin A1, sibling migrations, deprecations, publication, or push from this planning task.
