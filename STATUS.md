...
next: Review the verified `jaxstro.quad` Phase A2 boundary, then write a fresh Phase A3 plan for replay derivatives, moving-bound evidence, and the quantity boundary before changing those interfaces. Do not begin sibling migrations, deprecations, publication, push, later-dimensional methods, or performance-superiority claims.
