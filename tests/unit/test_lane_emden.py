r"""Lane-Emden solver core against EXACT closed-form oracles.
...
The isothermal (Bonnor-Ebert) case has no closed form, so it is checked against
...
from jaxstro.numerics.lane_emden import (
    polytrope_xi1,
    solve_isothermal,
    solve_polytrope,
)
...
class TestPolytropeExactSolutions:
    """The three closed-form Lane-Emden solutions."""
...
class TestPolytropeFirstZero:
    """xi_1 located by event detection, against exact values."""
